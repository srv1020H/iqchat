...
```
npm create cloudflare@latest -- --template=cloudflare/templates/iqchat
```

A live public deployment of this template is available at [https://iqchat.templates.workers.dev](https://iqchat.templates.workers.dev)
